...
import { ArrowRight, CheckCircle, Upload, Shield, Users, Layers, FileText, Layout, Lock, Clock, Building2 } from 'lucide-react';
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-4">
            <h2 className="text-sm font-bold tracking-wide uppercase text-ebox-forest mb-2">Your Real Estate Toolkit</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-white p-8 rounded-lg shadow-lg border border-gray-200 border-t-8 border-t-ebox-lime flex flex-col items-start hover:shadow-xl transition-shadow">
               ...
               <p className="text-lg text-gray-600 mb-8 flex-grow">Data imports for MRI. Built for property teams to eliminate errors and speed up processing.</p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg border border-gray-200 border-t-8 border-t-ebox-forest flex flex-col items-start hover:shadow-xl transition-shadow">
               ...
               <p className="text-lg text-gray-600 mb-8 flex-grow">Email thousands of recipients. Track every delivery. Handle correspondence directly from your data.</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl">
              eBox gives you user-friendly tools that connect directly to MRI. Build forms. Automate communications. Reduce friction.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { 
                ...
                title: "Smart Forms", 
                desc: "Pre-built templates for common real estate business processes. Or build custom forms." 
              },
              { 
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
            ...
            {[
              { step: "1", title: "Create", desc: "Capture or upload data. Takes minutes, not months." },
      ...
      <section className="py-24 bg-ebox-dark text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
             ...
             <h3 className="text-4xl font-bold">Turn hours into minutes.</h3>
             <p className="text-gray-400 mt-4 text-lg">eBox makes it faster and safer.</p>
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h3 className="text-4xl font-bold text-ebox-dark mb-4">Answer questions in seconds.</h3>
